...
class UIHelper {
  ...
  static double getAppTitleWidgetHeight() {
    return ScreenUtil().orientation == Orientation.portrait ? 0.16.sh : 0.13.sw;
  }

  static double getpokeballImageWidgetHeight() {
    return ScreenUtil().orientation == Orientation.portrait ? 0.15.sh : 0.13.sw;
  }
